...
class HostScreen{
    ...
    processQuizInitData(){
        console.debug(new Date(Date.now()).toISOString() + ": processQuizInitData "); 
    ...
    displayStartGameScreen(data){
        console.debug(new Date(Date.now()).toISOString() + ": displayStartGameScreen with data " + data);    
    ...
    gameCountdown() {
        ...
        console.debug(new Date(Date.now()).toISOString() + ": gameCountdown ");    
...
class PlayerScreen{
    ...
    onPlayerStartClick() {
        console.debug(new Date(Date.now()).toISOString() + ": onPlayerStartClick ");    
     ...
     */
    updateWaitingScreen() {
        console.debug(new Date(Date.now()).toISOString() + ": updateWaitingScreen for gameId " + this.gameId);    
...
class IO {
    ...
    onConnected(data) {
        ...
        console.debug(new Date(Date.now()).toISOString() + ": OnConnected with id " + data.id);            
    }
     ...
     */
    gameInit(data){
        console.debug(new Date(Date.now()).toISOString() + ": gameInit with data " + data);          
    ...
    playerJoinedRoom(serverData) {
        console.debug(new Date(Date.now()).toISOString() + ": playerJoinedRoom with serverData " + serverData);          
        ...
        if (quiz.roleScreen == 'Host') {
            console.debug(new Date(Date.now()).toISOString() + ": playerJoinedRoom roleScreen " + quiz.roleScreen);    
    ...
    beginNewGame(serverData) {
        console.debug(new Date(Date.now()).toISOString() + ": beginNewGame with serverData " + serverData);    
        if (quiz.roleScreen == 'Host') {
            console.debug(new Date(Date.now()).toISOString() + ": beginNewGame with Host " + quiz.roleScreen);    
